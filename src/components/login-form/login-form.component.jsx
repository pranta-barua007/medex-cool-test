...
import { requestLogin } from '../../redux/user/user.actions';
import { createStructuredSelector } from 'reselect';
import { selectUserIsPending, selectUserError } from '../../redux/user/user.selectors';
...
const LoginForm = ({ onSubmitSignin, userIsPending, errorLoading }) => {
...
const mapDispatchToProps = dispatch => {
    return {
        onSubmitSignin: (email, password) => dispatch(requestLogin(email, password))
    }
};
